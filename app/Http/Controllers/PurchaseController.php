...
class PurchaseController {
    ...
    public function store(Request $request): RedirectResponse {
        ...
        $this->audit->record('purchase.created',$purchase,[],['purchase_number'=>$purchase->purchase_number,'supplier_id'=>$purchase->supplier_id,'warehouse_id'=>$purchase->warehouse_id,'total_amount'=>(float)$purchase->total_amount]);
