...
<div class="sheet">
    <header class="header">
        <div>
            ...
            <div class="subtitle">Supplier Payment Record</div>
        </div>
        <div class="title">
    ...
    <section class="meta">
        ...
        <div class="meta-card"><span class="label">Supplier</span><span class="value">{{ $payment->supplier->company_name }}</span></div>
    ...
    <table>
        ...
        @forelse($payment->allocations as $allocation)
            <tr>
                <td>{{ $allocation->purchase->purchase_number }}</td>
                <td class="right">PKR {{ number_format($allocation->amount, 2) }}</td>
            </tr>
        @empty
            <tr>
                <td colspan="2">Unallocated supplier advance / payment</td>
            </tr>
        @endforelse
        </tbody>
        <tfoot>
    ...
    <section class="signatures">
        <div class="signature"><strong>Prepared By</strong><span>Name / Date / Signature</span></div>
